...
Ki = 10  #Bias update coefficient
Ka = 0.5  #accelerometer term coefficient in correction
...
def main():
    df = pd.read_csv('E:/Personal/ACAD/Project/Joint State Estimation/Ubuntu Code Backup/Project/csv/dataLive.csv') 
    data = np.array(df)
