...
#Function to calculate cross product matrix
def Vectocrossm(v):
...
#Below function is used to get Euler angles from R
...
#Following function is not used for Euler angles the one which is above this function is used
...
vlinear = np.array([0, 0, 0])    #calculate linear acceleration if required. In current code linear acceleration is not calculated
vg0 = np.array([[0], [0], [1]])
...
def calculateAng():
        ...
        if i != 0:   
            ...
            #Updating rotation matrix estimate
